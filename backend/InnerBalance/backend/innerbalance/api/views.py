# E:\2025\Archit\Inner-Balance\backend\InnerBalance\backend\innerbalance\api\views.py
    ...
    try:
        ...
        for question in questions:
            question_data.append({
                'id': question.id,
                'text': question.text,
                'question_type': question.question_type,  # Changed from 'type' to 'question_type'
                'type': question.question_type,  # Keep both for compatibility
